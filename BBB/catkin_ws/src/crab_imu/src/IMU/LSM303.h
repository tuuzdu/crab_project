...
#define LSM303_OUT_Z_H_M         0x05	//-1   // The addresses of the Y and Z magnetometer output registers
#define LSM303_OUT_Z_L_M         0x06	//-2   // are reversed on the DLM and DLHC relative to the DLH.
#define LSM303_OUT_Y_H_M         0x07	//-3   // These four defines have dummy values so the library can
#define LSM303_OUT_Y_L_M         0x08	//-4   // determine the correct address based on the device type.
...
//    LSM303(void);
	...
	void readAcc(void);
	void readMag(void);
	short convertMsbLsb(char msb, char lsb, char discard);
